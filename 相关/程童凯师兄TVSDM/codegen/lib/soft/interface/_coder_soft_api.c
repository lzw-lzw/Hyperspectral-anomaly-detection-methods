 ...
 * Return Type  : void
 */
void soft_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray *plhs[1])
{
  real_T x;
  real_T T;
...
/*
 * File trailer for _coder_soft_api.c
 *
 * [EOF]
 */
